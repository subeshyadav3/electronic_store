...
const ProductCard = ({ products }) => {
  ...
  return (
    <div
      ...
      className="bg-white shadow-lg w-[350px] mt-5 md:w-full mr-5 mb-5 rounded-xl transform transition-transform duration-300 hover:scale-105"
    >
      
      <img
        src={products.thumbnail}
        alt={products.title}
        className="w-full h-56 pt-5 object-cover hover:opacity-90 transition-opacity duration-300"
      />
